...
2. Set IP to value stored in the interrupt vector table entry for the timer interrupt
  ...
  The machine then switches to privileged mode and address translation is disabled.
